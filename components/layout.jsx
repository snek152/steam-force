					...
					<div className="relative flex items-center justify-between h-16">
						<div className="inset-y-0 left-0 flex items-center sm:hidden">
							<button
								...
								className="collapsed inline-flex items-center justify-center p-2 nav-toggler rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
			...
			<Menu as="div" className="ml-3 relative">
				...
				>
					<Menu.Items className="divide-gray-200 divide-y origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
						<div className="py-1">
							<p
								className="block px-4 py-1 text-sm text-gray-700 dropdown-item"
								tabIndex="-1"
								role="menuitem"
							>
